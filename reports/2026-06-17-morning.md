...
- **Testable** : Oui (si US ou VPN US) — via claude.ai, API Anthropic, Bedrock, Vertex AI, Microsoft Foundry
...
- **Quoi** : Mistral a renommé Le Chat en "Vibe" et le repositionne comme plateforme agentique pour le travail et le code. Work Mode (tâches longues), Code Mode (coding + PRs), extension VS Code, CLI. Sessions Slack prévues pour juin 2026
...
- **Pourquoi c'est important** : Mistral se positionne directement contre Cursor/Devin sur le code et contre Notion/Copilot sur la productivité. Annonce faite à l'AI Now Summit à Paris (28 mai). Plans : Free, Pro (14,99€/mois), Team (24,99€/user), Enterprise
- **Testable** : Oui — vibe.mistral.ai (Free tier disponible)

### Google Antigravity 2.0 — CLI shutdown Gemini le 18 juin
...
- **Quoi** : Annoncé à Build 2026 (2-3 juin), Scout est un agent autonome with identité Entra gouvernée qui fonctionne sans attendre de prompt. Connecté à Teams, Outlook, OneDrive, SharePoint. Motorisé par OpenClaw (modèle Microsoft interne)
...
### Google Gemini 3.5 Flash — dans Search avec agents
...
### Benchmark expert-level : 65% accuracy pour les PhD
- **Quoi** : 448 questions multi-choix rédigées par des experts en biologie, physique et chimie — niveau tel que les PhD atteignent seulement 65% de précision en moyenne (publié le 4 juin, Nature)
